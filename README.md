...
<p align="center">
    ...
    <i>[Architecture Diagram Placeholder]</i>
</p>
...
<p align="center">
    ...
    <i>[Dashboard Page Screenshot Placeholder]</i>
</p>
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Shoyeb45/eld-log-generator.git
   cd eld-log-generator
   ```
...
You can spin up the complete stack (Django, React, and PostgreSQL) with a single command:
